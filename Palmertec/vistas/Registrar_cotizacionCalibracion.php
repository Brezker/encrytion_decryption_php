...
<?php 
		...
		<div class="form-row">
			...
			<input type="text" name="modelo" class="form-control" id="modelo"  required maxlength="10" minlength="1">
		    </div>
			<div class="form-group col-md-4">	
			<label for="puntos_calibrar">Puntos a calibrar</label>
			<input type="text" name="puntos_calibrar" class="form-control" id="puntos_calibrar" readonly required maxlength="10" minlength="1" value="<?php echo $puntos;?>">
           </div>
		</div>	
        ...
        <div class="form-row">	
			...
			<input type="text" name="identificador" class="form-control" id="identificador"  required    maxlength="10" minlength="1">
	        </div><br>
			<div class="form-group col-md-4">	
			<label for="puntosext">Puntos adicionales</label>
			<label style="color: red"> Costo por punto  $<?php echo $NewPrice2; ?> </label>
			<input type="number" name="puntosext" class="form-control" id="puntosext" value="0"  required  maxlength="4	0" minlength="1">
	        </div>
			<div class="form-group col-md-4">	
