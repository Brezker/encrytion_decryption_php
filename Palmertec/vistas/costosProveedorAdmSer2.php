			...
			<div class="container">
				...
				if($row == 0){
					...
					<table class="table table-responsive text-nowrap">
						...
						<?php 
						$sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_registros FROM costos_servicios_dif WHERE cve_laboratorio = $idLab ");
						...
						costos_servicios_dif.cve_costo_servicio_dif,
						costos_servicios_dif.acreditamiento,
						costos_servicios_dif.servicio_escrito,
						costos_servicios_dif.equipo,
						costos_servicios_dif.costo,
						costos_servicios_dif.porcentaje_servicio,
						
						laboratorios.laboratorio
						 FROM costos_servicios_dif inner join laboratorios on costos_servicios_dif.cve_laboratorio=laboratorios.cve_laboratorio  WHERE laboratorios.cve_laboratorio = $idLab  ORDER BY equipo ASC LIMIT $por_pagina OFFSET $desde");
						...
						<tr>
								...
								<td><?php echo $data['servicio_escrito']; ?></td>
								<td><?php echo $data['equipo']; ?></td>
								<td><?php echo $data['costo']; ?></td>
								<td><?php echo $data['porcentaje_servicio']; ?>%</td>
							
							
								<td>									
									<a href="editar_costo_Administrador2.php?id=<?php echo $data['cve_costo_servicio_dif']; ?>"><i class="far fa-edit"></i></a>
