...
if($_SESSION['rol'] != "administrador"){	
	...
	<body>
		...
		<main class="main">
			<div class="container">
				<h1>Lista de unidades de medida registradas</h1>    
				...
				?>			
					<table class="table table-responsive">
						...
						$result = mysqli_query($conexion, "SELECT * FROM unidad_medidad inner join magnitud on unidad_medidad.id_magnitud=magnitud.id_magnitud ORDER BY id_unidadMed DESC LIMIT $por_pagina OFFSET $desde");
