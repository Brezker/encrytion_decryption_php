...
if($_SESSION['rol'] != "administrador"){	
	...
	<head>
		...
		<title>Actualizar Servicios de Calibración</title>
...
//Recuperar datos 
		$id_servicio= $_GET['id'];
		$sql = mysqli_query($conexion ,"SELECT * FROM todos_servicios inner join magnitud on todos_servicios.id_magnitud=magnitud.id_magnitud where id_servicio = $id_servicio");
		...
		<main class="main">
			<div class="container">
				<h1>Actualizar Servicios de Calibración</h1>
				<div class="form-register">		
					<form action="../controladores/actualizar_servicio_adm.php" method="post" class="bg-white shadow p-5 rounded-lg">
