...
if($_SESSION['rol'] != "administrador"){	
	...
	<head>
		...
		<title>Registrar servicios de mantenimiento</title>
	...
	<body>
		...
		<main class="main">
			<div class="container">
				<h1>Registrar servicios de mantenimiento</h1>	
		
				
				<div class="form-register">					
                <form action="../controladores/registrar_mantenimiento_adm.php" method="POST" class="bg-white shadow p-5 rounded-lg"><div class="col-md-4">
							<label for="calificacion_desempeño">Servicio</label>
							<input type="text" class="form-control" name="servicio" id="servicio" >
							<br>
							<label for="cicloDesempeño">Magnitud</label>
							<input type="hidden" class="form-control" name="id_magnitud" id="id_magnitud" >	
