		...
		<main class="main">
			...
			<?php
				...
				<div class="form-register">					
					<form action="../controladores/registro_servicios_calificacion.php" method="POST" class="bg-white shadow p-5 rounded-lg">
						...
						<div class="col-md-4">
							...
							<?php 
                        		$sql_servicio = mysqli_query($conexion, "SELECT DISTINCT servicios, id_serv FROM `servicios_dif` WHERE id_serv = 4");                    
						...
						<div class="col-md-6">
							...
							<label for="diseño">Costo</label>	
							<input type="text" class="form-control" name="diseño" id="diseño" >
							<br>
						</div>
						...
						<div class="col-md-6">
							...
							<label for="instalacion">Costo </label>	
						...
						<div class="col-md-6">
							...
							<label for="operacion">Costo </label>
							<input type="text" class="form-control" name="operacion" id="operacion">
						...
						<div class="col-md-6">
							...
							<label for="desempeño">Costo</label>
							<input type="text" class="form-control" name="desempeño" id="desempeño" >
							<br>
