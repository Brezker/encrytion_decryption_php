...
if($_SESSION['rol'] != "proveedor"){	
	...
	<head>
		...
		<title>Actualizar costos de Calibración</title>
...
function mostrar(id) {
	...
	<body>
		...
		<main class="main">
			<div class="container">
				<h1>Actualizar costos de Calibraci&oacute;n</h1>	
				...
				?>
					...
					<div class="text-center">
                        ...
                        <button type="submit" value="Registrar"  class="btn btn-primary btn-lg">Actualizar</button>
                        </div>  
        				</div>
						</div>
						<br><br>
