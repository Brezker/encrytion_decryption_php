<div class= "pb-5">
    <div class="row mt-5 mb-5">
        <div class="col-12 col-md-5 mx-auto">
            <form method="post" class="bg-white  shadow p-5 rounded-lg" action="controladores/validaciones.php">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="email" name="Correo" class="form-control" id="Correo" aria-describedby="emailHelp" placeholder="Ingresar correo electronico" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="password" class="form-control" id="Contraseña" name="Contraseña" placeholder="Ingresar contraseña" required>
                    </div>
                </div>
