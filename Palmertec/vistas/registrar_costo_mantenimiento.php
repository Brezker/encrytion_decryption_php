...
if($_SESSION['rol'] != "proveedor"){	
	...
	<head>
		...
		<title>Registrar costo mantenimiento</title>
	...
	<body>
		...
		<main class="main">
			<div class="container">
				...
				<h1>Registrar Costo Mantenimeinto</h1>	
		
				
				<div class="form-register">					
					<form action="../controladores/Registrar_MantenmientoProveedor.php" method="POST" class="bg-white shadow p-5 rounded-lg">
                        ...
                        <div class="col-md-3">
								...
								<input type="text" class="form-control" name="costoMantenimiento" id="costoMantenimiento" >
							</div>
