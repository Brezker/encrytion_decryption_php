	...
	<body>
		...
		<main class="main">
			<div class="container">
				...
				$result = mysqli_query($conexion, "SELECT * FROM detallepedido");
					...
					<table class="table table-responsive text-nowrap">
						<thead>
							<tr>
								...
								<th>Comentarios</th>
								<th>PDF</th>
								<th colspan="1">Aceptado</th>
								<th >Cancelar</th>
								<th >Notificar</th>
							</tr>
						</thead>
						<?php 
						$sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_registros FROM detallepedido");
						...
						while ($data = mysqli_fetch_array($result)) {
							...
							<tr>
								...
								<form method="post"  action="../controladores/AceptarPago.php">
                               ...
                               <i class="fas fa-file-pdf"></i>
								...
								<td>									
								<form method="post"  action="../controladores/Cancelar_Pedido.php">
                               <input type="hidden" name="id_detallePedido" value="<?php echo $data["id_detallePedido"] ?>">
							   <input type="hidden" name="Cotizacion_no" value="<?php echo $data["Cotizacion_no"] ?>">
