...
$Id_magnitud = mysqli_real_escape_string($conexion, $_POST['id_magnitud']);
	...
	$sql = mysqli_query($conexion, "INSERT INTO todos_servicios (servicio, id_magnitud) VALUES ('$Servicio','$Id_magnitud')");
	
	if($sql){
		echo '<script language="javascript">alert("Registro exitoso");</script> ';
		echo "<script>location.href='../vistas/mostrar_servicios_calibracion.php'</script>";	
		}else{	
