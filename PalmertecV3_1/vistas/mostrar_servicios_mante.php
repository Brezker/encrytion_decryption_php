			...
			<div class="container">
				...
				?>			
					<table class="table table-responsive">
						...
						$result = mysqli_query($conexion, "SELECT * FROM serviciosmantenimiento inner join magnitud on serviciosmantenimiento.id_magnitud=magnitud.id_magnitud ORDER BY servicio ASC LIMIT $por_pagina OFFSET $desde");
