...
if($_SESSION['rol'] != "administrador"){	
	...
	<head>
		...
		<title>Registrar Instrumentos</title>
	...
	<body>
		...
		<main class="main">
			<div class="container">
				<h1>Registrar Instrumentos</h1>	
				<div class="form-register">					
					<form action="../controladores/registrar_instrumentos_adm.php" method="POST" class="bg-white shadow p-5 rounded-lg"><div class="col-md-4">
							<label for="instrumento">Instrumento</label>
							<input type="text" class="form-control" name="instrumento" id="instrumento" >
							<br>
                        ...
                        while ($data_magnitud = mysqli_fetch_array($sql_magnitud)) {
							...
							$instrumento = $data_magnitud['magnitud'];
							echo '<option value="'.$id.'">'.$instrumento.'</option>';                   
                        }
                        ?>
                        </select> 
							<br>
