...
//Recuperar datos 
			...
			$sql = mysqli_query($conexion, "SELECT * FROM todos_servicios inner join magnitud on todos_servicios.id_magnitud=magnitud.id_magnitud where id_servicio = $idServicio");
				...
				<div class="form-register">		
					<div class="data-delete">
						...
						<form action="" method="post">
							...
							<a class="btn_cancel" href="mostrar_servicios_calibracion.php">Cancelar</a>
							
						</form>
						<form action="../controladores/eliminar_servicio_calibracion.php" method="post">
							<input type="hidden" name="id_servicio" value="<?php echo $id_servicio; ?>">
