			...
			<div class="container">
				...
				?>			
					<table class="table table-responsive">
						...
						$result = mysqli_query($conexion, "SELECT * FROM servicios_dif INNER JOIN magnitud ON servicios_dif.id_magnitud = magnitud.id_magnitud ORDER BY servicios ASC LIMIT $por_pagina OFFSET $desde");
