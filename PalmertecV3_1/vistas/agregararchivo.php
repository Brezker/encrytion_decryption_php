...
if($_SESSION['rol'] != "proveedor"){    
   ...
   $Cotizacion_no = $_REQUEST["Cotizacion_no"];  
    ...
    <body>
        ...
        $sql = mysqli_query($conexion, "SELECT * FROM detallepedido WHERE Cotizacion_no = '$Cotizacion_no'");
        ...
        $sel = mysqli_query($conexion, "SELECT * FROM archivos WHERE Cotizacion_no = '$Cotizacion_no'");   
        if(is_null($sel)){
                            ...
                            <tbody>
                                <?php foreach ($res as $val) { ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="eliminar_archivoCliente.php?Cotizacion_no=<?php echo $val['Cotizacion_no']; ?>"><i class="fas fa-file-pdf" ></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" id="form1">
                            ...
                            <div class="form-group">                                
                                <input type="hidden" class="form-control" id="description" name="description" value="<?php echo $Cotizacion_no; ?>">
                            </div> 
                              <label for="description">archivo</label>
                                ...
                                <div class="form-group">
                            <td><input type="checkbox" class="form-control" name="acepoli"  id="acepoli" required>Acepto las politicas</td><a href="..\vistas\archivos\politicas.pdf" target="_blank">       Leer politicas de servicio   </a>
                            </div>                          
                            <div class="form-group">
                            </div>
                        </form>
