...
function mostrar(id) {
   if (id == "clase") {
    ...
    <div class="form-register">		
             ...
             <form method="post" class="bg-white  shadow p-5 rounded-lg" action="costos_laboratoriosU.php">
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<div class="form-register">		
		...
		<form action="costo_laboratorios3U.php" method="post" class="bg-white shadow p-5 rounded-lg">
