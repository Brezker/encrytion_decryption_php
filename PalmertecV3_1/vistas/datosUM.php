...
$unidadmin=$_POST['unidadmin'];

	$sql="SELECT id_unidadMed,
			 id_magnitud,
			 unidadMedida 
		from unidad_medidad
		where id_magnitud='$unidadmin'";

	$result=mysqli_query($conexion,$sql);

	$cadena="<label>Unidad de medida</label>
    
            <select id_unidadMed='unidadmin' name='unidadmin' id='unidadmin' class='form-control' class='unidadmin' required>";
