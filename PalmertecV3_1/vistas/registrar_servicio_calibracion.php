...
if($_SESSION['rol'] != "administrador"){	
	...
	<head>
		...
		<title>Registrar servicios de calibracion</title>
	...
	<body>
		...
		<main class="main">
			<div class="container">
				<h1>Registrar servicio de calibración</h1>	
				<div class="form-register">					
					<form action="../controladores/registrar_servicio_adm.php" method="POST" class="bg-white shadow p-5 rounded-lg"><div class="col-md-4">
