		...
		<main class="main">
			<div class="container">
				...
				<div class="form-register">		
					...
					<div class="form-row">
                    <label for="">ID</label>
						<input type="text" class="form-control" name="id_instrumento" id="id_instrumento" value="<?php echo $id_instrumento ?>" readonly>
                        <label for="">Servicios</label>
						<input type="text" class="form-control" name="instrumento" id="instrumento" value="<?php echo $instrumento ?>">
