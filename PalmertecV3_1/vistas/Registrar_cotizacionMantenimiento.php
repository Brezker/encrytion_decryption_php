...
<?php 
		...
		<div class="form-row">
			...
			<input type="text" name="marcam" class="form-control" id="marcam"  required maxlength="50" minlength="1">
	                </div><br>	
			<div class="form-group col-md-3">
			<label for="modelom">Modelo</label>
			<input type="text" name="modelom" class="form-control" id="modelom"  required maxlength="50" minlength="1">
		    </div>
			<div class="form-group col-md-3">	
			<label for="identificadorm">Identificador</label>
			<input type="text" name="identificadorm" class="form-control" id="identificadorm"  required    maxlength="40" minlength="1">
	       </div>
           <div class="form-group col-md-4">	
