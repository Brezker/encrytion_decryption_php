...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-01-2022 a las 23:03:55
...
--
-- Estructura de tabla para la tabla `correosubscritores`
--

CREATE TABLE `correosubscritores` (
  `cve_correoSub` int(11) NOT NULL,
  `correo_sub` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(421, 'Masa', 'ILAC', 'Pesa', 500, 5, 0, 10, '100', 'g', '100', 'g', '0', ''),
(422, 'Masa', 'TRAZABILIDAD', 'Pesa', 200, 10, 0, 41, '100', 'g', '100', 'g', '0', '');
...
(20, 'TRAZABILIDAD', 1, 'Autoclave', 250, 250, 152, 200, 755, 200, 0, 250.00, 0.00, 0, 250.00, 0.00, 0, 152.00, 0.00, 0, 755.00, 0.00, 1);
...
(62, 23, 500, 9977, 1596, 11573, 'PAL-21-001', 'Pagado', ''),
(65, 36, 500, 1970, 315, 2285, 'PAL-21-003', 'En proceso', ''),
(66, 36, 500, 7536, 1206, 8742, 'PAL-21-004', 'Pagado', ''),
(67, 36, 0, 6760, 1082, 7842, 'PAL-21-005', 'En proceso', ''),
(68, 36, 500, 4088, 654, 4742, 'PAL-21-006', 'En proceso', ''),
(75, 32, 0, 1500, 240, 1740, 'PAL-21-007', 'En proceso', ''),
(76, 36, 500, 2226, 356, 2582, 'PAL-21-008', 'En proceso', ''),
(77, 32, 500, 35718, 5715, 41433, 'PAL-21-009', 'En proceso', ''),
(78, 41, 0, 1990, 318, 2308, 'PAL-22-0010', 'En proceso', ''),
(79, 41, 0, 1500, 240, 1740, 'PAL-22-0011', 'Pagado', ''),
(80, 41, 0, 1990, 318, 2308, 'PAL-22-0012', 'En proceso', ''),
(81, 41, 0, 1500, 240, 1740, 'PAL-22-0013', 'En proceso', ''),
(82, 41, 0, 4797, 768, 5565, 'PAL-22-0014', 'Pagado', ''),
(83, 41, 0, 4200, 672, 4872, 'PAL-22-0015', 'En proceso', ''),
(84, 41, 0, 4267, 683, 4950, 'PAL-22-0016', 'En proceso', ''),
(85, 41, 0, 21569, 3451, 25020, 'PAL-22-0017', 'En proceso', ''),
(86, 41, 0, 660, 106, 766, 'PAL-22-0018', 'En proceso', ''),
(87, 41, 0, 660, 106, 766, 'PAL-22-0019', 'En proceso', ''),
(88, 41, 0, 660, 106, 766, 'PAL-22-0020', 'En proceso', ''),
(89, 41, 0, 660, 106, 766, 'PAL-22-0021', 'En proceso', ''),
(90, 41, 0, 660, 106, 766, 'PAL-22-0022', 'En proceso', ''),
(91, 41, 0, 660, 106, 766, 'PAL-22-0023', 'En proceso', ''),
(92, 41, 0, 660, 106, 766, 'PAL-22-0024', 'En proceso', ''),
(93, 41, 0, 1500, 240, 1740, 'PAL-22-0025', 'En proceso', ''),
(94, 41, 0, 1500, 240, 1740, 'PAL-22-0026', 'En proceso', ''),
(95, 41, 0, 4360, 698, 5058, 'PAL-22-0027', 'En proceso', ''),
(96, 41, 0, 1500, 240, 1740, 'PAL-22-0028', 'En proceso', ''),
(97, 41, 0, 1500, 240, 1740, 'PAL-22-0029', 'En proceso', ''),
(98, 41, 0, 5200, 832, 6032, 'PAL-22-0030', 'En proceso', ''),
(99, 41, 0, 5200, 832, 6032, 'PAL-22-0031', 'En proceso', ''),
(100, 41, 0, 660, 106, 766, 'PAL-22-0032', 'En proceso', ''),
(101, 41, 0, 1900, 304, 2204, 'PAL-22-0033', 'En proceso', ''),
(102, 41, 0, 1900, 304, 2204, 'PAL-22-0034', 'En proceso', 'sin comentarios'),
(103, 41, 0, 3285, 526, 3811, 'PAL-22-0035', 'En proceso', ''),
(104, 41, 0, 3285, 526, 3811, 'PAL-22-0036', 'En proceso', ''),
(105, 41, 0, 3285, 526, 3811, 'PAL-22-0037', 'En proceso', ''),
(106, 41, 0, 2450, 392, 2842, 'PAL-22-0038', 'En proceso', ''),
(107, 41, 0, 4200, 672, 4872, 'PAL-22-0039', 'En proceso', ''),
(108, 41, 0, 4700, 752, 5452, 'PAL-22-0040', 'En proceso', ''),
(109, 41, 0, 1900, 304, 2204, 'PAL-22-0041', 'En proceso', ''),
(110, 41, 0, 1900, 304, 2204, 'PAL-22-0042', 'En proceso', ''),
(111, 41, 0, 2250, 360, 2610, 'PAL-22-0043', 'En proceso', ''),
(112, 41, 0, 2860, 458, 3318, 'PAL-22-0044', 'En proceso', ''),
(113, 41, 0, 2860, 458, 3318, 'PAL-22-0045', 'En proceso', ''),
(114, 41, 0, 1500, 240, 1740, 'PAL-22-0046', 'En proceso', ''),
(115, 41, 0, 1500, 240, 1740, 'PAL-22-0047', 'En proceso', ''),
(116, 41, 0, 1990, 318, 2308, 'PAL-22-0048', 'En proceso', ''),
(117, 41, 0, 580, 93, 673, 'PAL-22-0049', 'En proceso', '');
...
CREATE TABLE `promociones` (
  `cve_promociones` int(11) NOT NULL,
  `nom_mes` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `promocion1` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `img1` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `imgBinario1` mediumblob DEFAULT NULL,
  `imgTipo1` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `promocion2` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `img2` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `imgBinario2` mediumblob DEFAULT NULL,
  `imgTipo2` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `promocion3` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `img3` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `imgBinario3` mediumblob DEFAULT NULL,
  `imgTipo3` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `promocion4` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `img4` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `imgBinario4` mediumblob DEFAULT NULL,
  `imgTipo4` text CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indices de la tabla `correosubscritores`
--
ALTER TABLE `correosubscritores`
  ADD PRIMARY KEY (`cve_correoSub`);
...
ALTER TABLE `promociones`
  ADD PRIMARY KEY (`cve_promociones`);
...
--
-- AUTO_INCREMENT de la tabla `correosubscritores`
--
ALTER TABLE `correosubscritores`
  MODIFY `cve_correoSub` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `costos_mantenimiento`
--
ALTER TABLE `costos_mantenimiento`
  MODIFY `cve_costo_mantenimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;

--
-- AUTO_INCREMENT de la tabla `costos_proveedor`
--
ALTER TABLE `costos_proveedor`
  MODIFY `cve_costo_proveedor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=423;

--
-- AUTO_INCREMENT de la tabla `costos_servicios`
--
ALTER TABLE `costos_servicios`
  MODIFY `cve_costo_servicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `detallepedido`
  MODIFY `id_detallePedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT de la tabla `instrumentos`
--
ALTER TABLE `instrumentos`
  MODIFY `id_instrumento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;

--
-- AUTO_INCREMENT de la tabla `magnitud`
--
ALTER TABLE `magnitud`
  MODIFY `id_magnitud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `pedidocalibracion`
--
ALTER TABLE `pedidocalibracion`
  MODIFY `id_pedidoCalibracion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT de la tabla `pedidomantenimiento`
--
ALTER TABLE `pedidomantenimiento`
  MODIFY `id_pedidoMantenimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT de la tabla `pedidoservicio`
--
ALTER TABLE `pedidoservicio`
  MODIFY `id_pedidoServicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;

--
-- AUTO_INCREMENT de la tabla `promociones`
--
ALTER TABLE `promociones`
  MODIFY `cve_promociones` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `servicios`
--
ALTER TABLE `servicios`
  MODIFY `id_servicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=127;
...
--
ALTER TABLE `unidad_medidad`
  MODIFY `id_unidadMed` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
